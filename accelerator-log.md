...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"redisCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7973599401488325127, --data-values-file, /tmp/accelerator-options8183631082797426285.json, --output-files, /tmp/ytt-output6651354929552854071]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"redisCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17302154827465202307, --data-values-file, /tmp/accelerator-options12291490962923469871.json, --output-files, /tmp/ytt-output7251263972915815757]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"redisCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1523457802309018729, --data-values-file, /tmp/accelerator-options4914101293346180647.json, --output-files, /tmp/ytt-output17901706298157978862]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"redisCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6047662990449697639, --data-values-file, /tmp/accelerator-options16534303507153169105.json, --output-files, /tmp/ytt-output13717538319045727033]
